...
namespace Merchants.Api.Controllers.Integrations
{
    ...
    public class NayaxApiController : ApiControllerBase
    {
        ...
        public async Task<ActionResult<OperationResponse>> TestConnection(ExternalSystemRequest request, string deviceTerminalID)
        {
            ...
            AuthRequest req = new AuthRequest(deviceTerminalID, request.TerminalID);//settings.. //request.Settings.externalSystemSettings.);
