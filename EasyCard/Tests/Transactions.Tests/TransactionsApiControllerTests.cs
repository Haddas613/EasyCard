...
namespace Transactions.Tests
{
    ...
    public class TransactionsApiControllerTests
    {
        ...
        public async Task CreateTransactionWithCreditCard_CreatesWhenModelIsCorrect()
        {
            ...
            var actionResult = await controller.CreateTransactionWithCreditCard(transactionRequest);
        ...
        public async Task CreateTransactionWithToken_ReturnsErrorWhenProcessorFails()
        {
            ...
            procResolverMock.ResolverMock.Verify(m => m.GetProcessor(It.IsAny<Terminal>()), Times.Once);
            procResolverMock.ProcessorMock.Verify(m => m.CreateTransaction(It.IsAny<ProcessorTransactionRequest>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once);
