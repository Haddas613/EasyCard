...
export default {
  ...
  methods: {
    async deleteCustomer() {
      let result = await this.$api.merchants.deleteConsumer(
  ...
  async mounted() {
    ...
    let customer = await this.$api.merchants.getConsumer(this.$route.params.id);
