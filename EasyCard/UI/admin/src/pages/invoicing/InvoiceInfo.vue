<template>
  <v-flex>
    <resend-invoice-dialog v-if="model" :show.sync="showResendDialog" :invoice="model" @ok="init()" />
                ...
                <v-col cols="12" md="4" class="info-block">
                  ...
                  <p class="error--text">
                    <router-link
                      ...
                      :to="{
                        name: 'EditTerminal',
                        params: { id: model.$terminalID || model.terminalID },
                      }"
                    >
                      {{ model.terminalName }}
                    </router-link>
...
export default {
  components: {
    ...
    IntegrationLogsList: () => import('../../components/integration-logs/IntegrationLogsList'),
    InvoiceHistory: () => import('../../components/invoicing/InvoiceHistory'),
