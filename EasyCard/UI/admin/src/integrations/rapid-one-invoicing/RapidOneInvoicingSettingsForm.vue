  ...
  <v-form v-model="formValid" lazy-validation>
    <v-row v-if="model.settings">
      <v-col cols="12" md="6" class="py-0">
        <v-text-field v-model="model.settings.url" :label="$t('URL')" outlined></v-text-field>
      </v-col>
      <v-col cols="12" md="6" class="py-0">
        <v-text-field v-model="model.settings.apiKey" :label="$t('ApiKey')" outlined></v-text-field>
      </v-col>
    </v-row>
