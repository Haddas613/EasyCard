...
namespace Transactions.Business.Migrations
{
    ...
    [Migration("20221207133946_DisableCancelPayment_added")]
    partial class DisableCancelPayment_added
    {
            ...
            modelBuilder.Entity("Transactions.Business.Entities.BillingDeal", b =>
                {
                    ...
                    b.Property<string>("LastErrorCorrelationID")
                        .HasMaxLength(50)
                        .IsUnicode(false)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Transactions.Business.Entities.CreditCardTokenDetails", b =>
                {
                    ...
                    b.Property<DateTime?>("CardExpirationBeforeExtendedDate")
                        .HasColumnType("date")
                        .HasColumnName("CardExpirationBeforeExtendedDate");

                    b.Property<string>("CardExpirationOld")
                        .HasMaxLength(5)
                        .IsUnicode(false)
                        .HasColumnType("varchar(5)")
                    ...
                    b.Property<Guid?>("ReplacementOfTokenID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("Active", "MerchantID", "ConsumerID");

                    b.HasIndex("Active", "TerminalID", "ConsumerID");
            ...
            modelBuilder.Entity("Transactions.Business.Entities.NayaxTransactionsParameters", b =>
                {
                    ...
                    b.Property<string>("PinPadTranRecordReceiptNumber")
                        .HasMaxLength(50)
                        .IsUnicode(false)
                        .HasColumnType("varchar(50)")
                        .HasColumnName("PinPadTranRecordReceiptNumber");
                    ...
                    b.HasIndex("PinPadTranRecordReceiptNumber")
                        .IsUnique()
                        .HasFilter("[PinPadTranRecordReceiptNumber] IS NOT NULL");
            ...
            modelBuilder.Entity("Transactions.Business.Entities.PaymentRequest", b =>
                {
                    ...
                    b.Property<bool?>("ConsumerDataReadonly")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("DisableCancelPayment")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("NationalIDRequired")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool?>("SaveCreditCardByDefault")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Transactions.Business.Entities.PaymentTransaction", b =>
                {
                    ...
                    b.Property<string>("PinPadDeviceID")
                        .HasMaxLength(20)
                        .IsUnicode(false)
                        .HasColumnType("varchar(20)")
                    ...
                    b.OwnsOne("Transactions.Business.Entities.DealDetails", "DealDetails", b1 =>
                        {
                            ...
                            b1.Property<string>("ConsumerName")
                                .HasMaxLength(50)
                                .IsUnicode(true)
                                .HasColumnType("nvarchar(50)")
                                .HasColumnName("ConsumerName");

                            b1.Property<string>("ConsumerNationalID")
                                .HasMaxLength(20)
                                .IsUnicode(false)
                                .HasColumnType("varchar(20)")
                                .HasColumnName("ConsumerNationalID");
                    ...
                    b.OwnsOne("Transactions.Business.Entities.ShvaTransactionDetails", "ShvaTransactionDetails", b1 =>
                        {
                            ...
                            b1.Property<string>("CompRetailerNum")
                                .HasMaxLength(20)
                                .IsUnicode(false)
                                .HasColumnType("varchar(20)")
                                .HasColumnName("CompRetailerNum");

                            b1.Property<string>("EmvSoftVersion")
                                .HasMaxLength(20)
                                .IsUnicode(false)
                                .HasColumnType("varchar(20)")
                                .HasColumnName("EmvSoftVersion");
                            ...
                            b1.Property<string>("TelToGetAuthNum")
                                .HasMaxLength(20)
                                .IsUnicode(false)
                                .HasColumnType("varchar(20)")
