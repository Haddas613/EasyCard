        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentRequestTimestamp = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    InvoiceSubject = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SendCCTo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DefaultInvoiceItem = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    PaymentRequestAmount = table.Column<decimal>(type: "decimal(19,4)", nullable: false),
