...
{
    [NonController]
    public class RegistrationController_old : Controller
    {
        ...
        public RegistrationController_old(
        ...
        {
            var model = new RegisterViewModel_old
            {
        ...
        private async Task<IActionResult> Register(RegisterViewModel_old model)
        {
