...
namespace PoalimOnlineBusiness
{
    public class Header
    {
        ...
        //2	2	8	 N Institute Number Must be 8 digits.Provided by MASAV.
        ...
        [FixedLengthFile(12, 70, 56, DataType.X)]
        public string Filler4 { get; set; } = string.Empty;

        //13	126	3	 X Header ID 	 'KOT'
        [FixedLengthFile(13, 126, 3, DataType.X)]
