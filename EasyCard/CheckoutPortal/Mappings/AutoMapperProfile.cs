        ...
        private void RegisterTerminalMappings()
        {
            ...
            CreateMap<PaymentRequestInfo, ChargeViewModel>()
                ...
                .ForMember(d => d.TransactionType, o => o.MapFrom((f, src) =>
                   (src.TransactionType == null ? f.TransactionType ?? TransactionTypeEnum.RegularDeal: src.TransactionType)))
            ...
            CreateMap<Transactions.Api.Models.Checkout.TerminalCheckoutCombinedSettings, ChargeViewModel>()
                ...
                .ForMember(d => d.AllowRegular, o => o.MapFrom(src => src.AllowRegular))
                .ForMember(d => d.AllowInstallments, o => o.MapFrom(src => src.AllowInstallments))
                .ForMember(d => d.AllowImmediate, o => o.MapFrom(src => src.AllowImmediate))
                ...
                .ForMember(d => d.HideDealDescription, o => o.MapFrom(src => src.HideDealDescription))
                .ForMember(d => d.DisableCancelPayment, o => o.MapFrom(src => src.DisableCancelPayment))
                .ForAllOtherMembers(d => d.Ignore());
