...
namespace Merchants.Shared {
    ...
    public class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Approve is not possible. Please check integration settings for {0}.
        /// </summary>
        public static string CheckIntegrationSettings {
            get {
                return ResourceManager.GetString("CheckIntegrationSettings", resourceCulture);
            }
        }
